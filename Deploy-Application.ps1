...
Try {
	...
	[string]$appScriptDate = '10/26/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		## OfficeConnect
		## Please note: This installs OfficeConnect on a per-user basis. The users can install future updates on their own, without administrative permissions.
		## 				The per-user installation creates install files, registry entries, and certificates in the user profile.
		Write-Log -Message "Attempting to run installer..." -Source 'Installation' -LogType 'CMTrace'
		$exitCode = Execute-Process -Path "$dirFiles\OfficeConnectSetup.exe" -Parameters "/quiet" -WindowStyle "Hidden" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$exitCode = Execute-Process -Path "$dirFiles\OfficeConnectSetup.exe" -Parameters "/quiet /uninstall /norestart" -WindowStyle "Hidden" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUbD7tO+aTfncSvlDPAWSUCX9a
# n8qgghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFGub9ylSN9aty0j+E+29mhCWmZdPMA0GCSqGSIb3DQEBAQUABIIBgAhulC0C
# NoaMcIx7YsEL/awY964Xvi5aXTXVDDF4VgwhQRsABJe+H/satjErCZh8J7T0x4lL
# zgxyeyNN8s5KEjjILT+FgZFDtnDsy83wWu6IjKAjlXuJ9q588MmYVOz5iWyDSiYT
# f+urf8VUlUlqIOn6lFB3JwqJqocKqj75Pg9wZFJx1G8B9ohIuM+8tmfUtLq++1gO
# q9h00TnPtc3rsIciqruWrhyo4YBruku0JjevHptQqzqRpVvO6B/DHDwp+76A74eN
# ZNeG8fIWKWs4sE6lcNrq0ePrlpX6NOFm/ZY27lUWuJE1bYo0mtmdP/hMxX8wUlAE
# BH+jLkOReGIVPK9vuD/I4E4lDwbYIOZHvb2DGsuLPgPo0VmT53X+rYHVPKXE3tdN
# x1AJzSWPoozKG1tDLZG1K6xaR+xd7J5wV2EmB+BiytTyrkezfImhtnLmdSa+Lc+d
# Z4U+q8hSjWKRwVokQdOAoGiflmploTm39USL13Q7wk3JTnkbmNsX05J/+A==
